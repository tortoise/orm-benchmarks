...
from pony.orm import Database, Json, LongUnicode, Optional, Required, Set
...
if test == 3:
    ...
    class Journal(db.Entity):
        ...
        col_text1 = Required(LongUnicode, default="Moo,Foo,Baa,Waa,Moo,Foo,Baa,Waa,Moo,Foo,Baa,Waa")
        col_decimal1 = Required(Decimal, 12, 8, default=Decimal("2.2"))
        col_json1 = Required(Json, default={"a": 1, "b": "b", "c": [2], "d": {"e": 3}, "f": True})
