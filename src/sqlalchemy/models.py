...
if test == 3:
    class Journal(Base):
        ...
        col_text1 = Column(Text, default='Moo,Foo,Baa,Waa,Moo,Foo,Baa,Waa,Moo,Foo,Baa,Waa', nullable=False)
        col_decimal1 = Column(Numeric(12, 8), default=Decimal('2.2'), nullable=False)
        col_json1 = Column(JSON, default={'a':1, 'b':'b', 'c':[2], 'd':{'e': 3}, 'f': True}, nullable=False)
        ...
        col_text3 = Column(Text, default='Moo,Foo,Baa,Waa,Moo,Foo,Baa,Waa,Moo,Foo,Baa,Waa', nullable=False)
        col_decimal3 = Column(Numeric(12, 8), default=Decimal('2.2'), nullable=False)
        col_json3 = Column(JSON, default={'a':1, 'b':'b', 'c':[2], 'd':{'e': 3}, 'f': True}, nullable=False)
