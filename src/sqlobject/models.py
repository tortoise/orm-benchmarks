...
if test == 3:
    class Journal(SQLObject):
        ...
        col_text1 = UnicodeCol(default='Moo,Foo,Baa,Waa,Moo,Foo,Baa,Waa,Moo,Foo,Baa,Waa', notNone=True)
        col_decimal1 = DecimalCol(size=12, precision=8, default=Decimal('2.2'), notNone=True)
        col_json1 = JSONCol(default={'a':1, 'b':'b', 'c':[2], 'd':{'e': 3}, 'f': True}, notNone=True)
