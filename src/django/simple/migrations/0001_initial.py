    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('col_decimal1', models.DecimalField(decimal_places=8, default=Decimal('2.2'), max_digits=12)),
                ('col_json1', jsonfield.fields.JSONField(default={'a': 1, 'b': 'b', 'c': [2], 'd': {'e': 3}, 'f': True})),
                ...
                ('col_decimal2', models.DecimalField(decimal_places=8, max_digits=12, null=True)),
                ...
                ('col_decimal3', models.DecimalField(decimal_places=8, default=Decimal('2.2'), max_digits=12)),
                ('col_json3', jsonfield.fields.JSONField(default={'a': 1, 'b': 'b', 'c': [2], 'd': {'e': 3}, 'f': True})),
                ...
                ('col_decimal4', models.DecimalField(decimal_places=8, max_digits=12, null=True)),
